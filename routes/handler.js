...
const countries = [
  ...
  { id: 3, name: "Békés megye", value: "Békés megye", label: "Békés megye" },
  {
    ...
    label: "Borsod-Abaúj-Zemplén megye",
  },
  ...
  { id: 11, name: "Heves megye", value: "Heves megye", label: "Heves megye" },
  {
    ...
    label: "Jász-Nagykun-Szolnok megye",
  },
  {
    id: 13,
    name: "Komárom-Esztergom megye",
    value: "Komárom-Esztergom megye",
    label: "Komárom-Esztergom megye",
  },
  {
    id: 14,
    name: "Nógrád megye",
  ...
  },
  {
    ...
    label: "Szabolcs-Szatmár-Bereg megye",
  },
...
const selectCitiesByCountry = (citiesWithCountries, countryId) => {
  ...
  if (citiesWithCountries.length >= 1) {
    filtered = citiesByCountry.filter(
      (city) => city.megyeid === countryId + ""
    );
  }
